...
for i, ext in enumerate(['3', '6', '-3']):
    ...
    for j, line in enumerate(f.readlines()):
        ...
        if j > 0:
            ...
            votlages.append(int(ext))
            dticks.append(diff*100)
...
plt.figure(6)
plt.title("Frequency of encoder ticks versus Voltage")
plt.ylabel("frequency")
plt.xlabel("Voltage")
plt.scatter(votlages, dticks)
plt.savefig('freq_vs_voltage.png')
