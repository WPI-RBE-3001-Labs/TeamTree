...
plt.figure(6)
data = pandas.read_csv('./no_weight.csv')
plt.title("Response for No Weight")
plt.xlabel("Time Steps")
plt.ylim(-1, 75)
handles = plt.plot(data)
plt.legend(handles, data.columns.values, loc=4)
plt.savefig("no_weight.png")

plt.figure(7)
data = pandas.read_csv('./heavy_weight.csv')
plt.title("Response for Heavy Weight")
plt.xlabel("Time Steps")
plt.ylim(-1, 75)
handles = plt.plot(data)
plt.legend(handles, data.columns.values, loc=4)
plt.savefig("heavy_weight.png")

plt.figure(8)
data = pandas.read_csv('./light_weight.csv')
plt.title("Response for Light Weight")
plt.xlabel("Time Steps")
plt.ylim(-1, 75)
handles = plt.plot(data)
plt.legend(handles, data.columns.values, loc=4)
plt.savefig("light_weight.png")
plt.show()
